...
const ClassTable=()=>{
  ...
  const handleEditState = id => {
   ...
   if(activeItem.status==null){
    ...
    axios.put("/class/update", activeItem).then(res=>{
      console.log(res);
    }).catch(error=>{
  ...
  const handleDelete = (id) => {
    ...
    console.log(id);
    if(window.confirm("Are you sure wann delete the Class ?")){
      axios.delete("/class/delete?id="+id).then(res=>{
        console.log(res);
  ...
  return (
    ...
    >
      ...
      <Column width={300} fullText sortable>
        ...
        <Cell dataKey="instructor_id['name']" onChange={handleChange} />
      </Column>
      <Column width={300} fullText sortable>
      ...
      <Column width={300} fullText sortable>
        ...
        <Cell dataKey="start_time" onChange={handleChange} />
      </Column>

      <Column width={300} fullText sortable>
        <HeaderCell>End Time</HeaderCell>
        <Cell dataKey="end_time" onChange={handleChange} />
      </Column>
